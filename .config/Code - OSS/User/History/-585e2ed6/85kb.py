...
def create_video(title, description, thumbnail, download, quality):
    connection = create_connection()
    if connection:
        try:
            with connection.cursor() as cursor:
                insert_query = '''
                    INSERT INTO youtube (title, description, thumbnail, download, quality)
                    VALUES (%s, %s, %s, %s, %s, %s, %s);
                '''
                cursor.execute(insert_query, (title, description,
                               thumbnail, download, quality))
                connection.commit()
...
def find_video(video_id=None, title=None):
...
create_video(
        ...
        quality="This is a tutorial video on how to learn Python programming for beginners.")


#logger.info(read_videos())
# title, description, thumbnail, download, quality